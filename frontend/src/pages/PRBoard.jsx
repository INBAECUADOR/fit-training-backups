      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="text-right flex items-center gap-2">
            ...
            <div>
              <p className="text-2xl font-extrabold text-gym-300">{prs.length}</p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-6">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2.5 bg-gym-800 border border-gym-700 rounded-xl text-white text-sm placeholder-gray-500 focus:outline-none focus:border-gym-400 transition"
            />
          </div>
        ...
        {filtered.length === 0 ? (
          ...
          <div className="space-y-2">
            {filtered.map(pr => (
              <div key={pr.exercise_id} className="bg-gym-800/50 border border-gym-700/30 rounded-xl px-4 py-3 hover:bg-gym-800/70 transition flex items-center justify-between">
